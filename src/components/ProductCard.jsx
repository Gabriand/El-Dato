...
export default function ProductCard({
    ...
    const disponibleClasses = {
        ...
        "En algo": "bg-yellowb text-yellowt",
    ...
    const maxPrice = hasPrevious
        ? hasCurrent
            ? Math.max(parsedCurrent, parsedPrevious)
            : parsedPrevious
        : null;
    ...
    const showPrevious =
        ...
        maxPrice > minPrice;
    const imageSrc = urlImg || "https://via.placeholder.com/320?text=Producto";
        ...
        >
            ...
            <div className="w-full">
                ...
                <div className="flex gap-1 mb-2">
                    ...
                    <p className="text-muted">{lugar}</p>
                </div>
                <div className="flex gap-2 items-end">
                    <p
                        className="text-primary font-bold text-4xl"
                        aria-label="Precio más barato"
                    >
                        {Number.isFinite(minPrice)
                            ? `$${minPrice.toFixed(2)}`
                            : "--"}
                    ...
                    {showPrevious && (
                        <p
                            className="line-through text-xl font-light text-muted"
                            aria-label="Precio más caro"
                        >
                            ${maxPrice.toFixed(2)}
                        </p>
                    )}
